...
DecoderCustomMultiTone::DecoderCustomMultiTone(float samplingRate, int windowSize) : Decoder(samplingRate, windowSize, Globals::numTokensCustom, Globals::numTonesCustomMultiTone)
{
#ifdef _IOS_LOG_
