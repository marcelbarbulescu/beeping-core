...
DecoderHiddenMultiTone::DecoderHiddenMultiTone(float samplingRate, int windowSize) : Decoder(samplingRate, windowSize, Globals::numTokensHidden, Globals::numTonesHiddenMultiTone)
{
#ifdef _IOS_LOG_
