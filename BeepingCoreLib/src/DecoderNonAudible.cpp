...
DecoderNonAudible::DecoderNonAudible(float samplingRate, int windowSize) : Decoder(samplingRate, windowSize, Globals::numTokensNonAudible, Globals::numTokensNonAudible)
{
#ifdef _IOS_LOG_
