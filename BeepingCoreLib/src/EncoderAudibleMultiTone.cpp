...
EncoderAudibleMultiTone::EncoderAudibleMultiTone(float samplingRate, int windowSize) : Encoder(samplingRate, windowSize, Globals::numTokensAudible, Globals::numTonesAudibleMultiTone)
{
