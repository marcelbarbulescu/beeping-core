...
EncoderNonAudible::EncoderNonAudible(float samplingRate, int windowSize) : Encoder(samplingRate, windowSize, Globals::numTokensNonAudible, Globals::numTokensNonAudible)
{
